...
Student::Student(string firstName, string midName, string lastName,
                 string studentUserName, int ID, string _major, string _minor, string _status){
...
void Student::setStatus() {
    cout<< "What is the students status"<<endl;
    cin>> status;
}
...
void Student::setSemester() {
    cout<< "What is the students semester"<<endl;
    cin>> semesterName;
}
...
string Student::getSemesterName(){
    return semesterName;
}
...
void Student::addCourse(Course* c){
    courseWork.appendNode(c);

}void Student::deleteCourse(int num) {
    courseWork.deleteNode(num);
}

void Student::searchCourse(int num) {
    courseWork.searchNode(num);
}

void Student::insertCourse(Course *c) {
    courseWork.insertNode(c);
}